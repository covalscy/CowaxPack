package com.cowax.cowaxpack.client.model.curio;
...
public class ParachuteModel extends HumanoidModel<LivingEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(CowaxPack.loc("parachute"), "main");
