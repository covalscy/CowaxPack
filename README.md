...
**CowaxPack** — специализированный военный аддон для модификации **SuperbWarfare** на базе Minecraft Forge 1.20.1. Мод добавляет тяжелую технику (ЗПРК 2С6 «Зенитка», бронемашины серии FV), кастомные зенитные снаряды с дистанционным подрывом и тактический парашют.
...
* **ЗПРК 2С6 «Зенитка» (`zenit_2c6`)**:
  ...
  * **Вооружение:** Спаренные скорострельные автопушки с зенитными снарядами (`ZenitCannonShellEntity`) с разрывным уроном и возможностью дистанционного подрыва / осколочного действия, а также пусковые установки ПТУР.
  * **Системы:** Поворотная башня с независимым наведением блока орудий по вертикали, реалистичная физика, система перегрева/перезарядки, радарный захват воздушных целей и звуковое сопровождение (`CowaxSounds`).
* **Боевая машина FV (`fv`)**:
...
| Предмет | ID | Описание |
| :--- | :--- | :--- |
| **Тактический парашют** | `cowaxpack:parachute` | Экипировка для экстренного десантирования из техники и высотных прыжков без получения урона от падения (слот Curios / инвентарь). |
...
* **Исходный код (Code):** Распространяется под лицензией **[GNU General Public License v3.0 (GPL-3.0)](LICENSE)** в соответствии с лицензионными условиями базовой модификации [SuperbWarfare](https://github.com/Mercurows/SuperbWarfare). Вы имеете право свободно изучать, модифицировать и распространять код при сохранении копилефт-лицензии GPL-3.0 и указании авторства.
* **Ресурсы и ассеты (Models, Textures, Sounds):** Авторские 3D-модели, анимации, текстуры и звуковые эффекты (ЗПРК 2С6, FV, снаряжение CowaxPack) являются собственностью авторов **Cowax / CowaxMC**.
* **Базовый мод (SuperbWarfare):** Все права на оригинальный мод SuperbWarfare, его API и оригинальные ассеты принадлежат **Atsuishio**, **Mercurows** и команде SuperbWarfare Team.
